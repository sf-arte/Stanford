        ...
        didSet {
            ...
            while answerIndex < qanda.answers.count {
                if qanda.answers[answerIndex] == answer {
                    ...
                    Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(chooseAnswer(timer:)), userInfo: indexPath , repeats: false)
                    break
                }
                answerIndex += 1
            }
